# Django settings for sokratik project.
import os.path
...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/pupun/sokratik/sokratikDB.db',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = [
    os.path.join(SITE_ROOT , "/myhome/static"),
]
...
SECRET_KEY = 'qph3rww&z89npp0gj3-o&q@*0)as9r@!d=u+9st+nsc105q!94'
...
ROOT_URLCONF = 'sokratik.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sokratik.wsgi.application'
